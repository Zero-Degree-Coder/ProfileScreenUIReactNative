    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={{
            ...
            <View style={styles.profileImageContainer}>
                <Image source={require("../assets/dp.png")} style={styles.profileImage} />
            ...
            <View style={styles.inputFieldsContainer}>
                ...
                <CustomInput
                    ...
                    icon={
                        <Feather name={"phone"} size={iconSize.md} color={colors.iconSecondary} style={styles.icon} />
                    }
                ...
                <CustomInput
                    label='Website'
                    placeholder='www.zerodegreecoder.in'
                ...
                <CustomInput
                    ...
                    placeholder='*******'
                    icon={
                        <AntDesign name={"lock1"} size={iconSize.md} color={colors.iconSecondary} style={styles.icon} />
                    }
                    type='password'
